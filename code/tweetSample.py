...
# For debugging HTTP errors, uncomment the next two lines.
#import httplib
...
def get_parser():
    import argparse
    parser = argparse.ArgumentParser(description='Sample the Twitter stream')
    return parser
...
print >> sys.stderr, 'Starting to sample the tweet stream'
